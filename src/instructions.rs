...
pub enum Instruction {
    ...
    SubtractAWithHL,
    SubtractAWithA,
    SubtractWithCarryAWithB,
    SubtractWithCarryAWithC,
    SubtractWithCarryAWithD,
    SubtractWithCarryAWithE,
    SubtractWithCarryAWithH,
    SubtractWithCarryAWithL,
    SubtractWithCarryAWithHL,
    SubtractWithCarryAWithA,
    AndAWithB,
    AndAWithC,
    AndAWithD,
    AndAWithE,
...
impl Instruction {
    pub fn size(&self) -> u16 {
        match self {
            ...
            Instruction::ComplimentCarryFlag => 1,
            ...
            Instruction::AddAWithC => 1,
            Instruction::AddAWithD => 1,
            Instruction::AddAWithE => 1,
            Instruction::AddAWithH => 1,
            Instruction::AddAWithL => 1,
            Instruction::AddAWithHL => 1,
            Instruction::AddAWithA => 1,
            Instruction::AddWithCarryAWithB => 1,
            Instruction::AddWithCarryAWithC => 1,
            Instruction::AddWithCarryAWithD => 1,
            Instruction::AddWithCarryAWithE => 1,
            Instruction::AddWithCarryAWithH => 1,
            Instruction::AddWithCarryAWithL => 1,
            Instruction::AddWithCarryAWithHL => 1,
            Instruction::AddWithCarryAWithA => 1,
            Instruction::SubtractAWithB => 1,
            Instruction::SubtractAWithC => 1,
            Instruction::SubtractAWithD => 1,
            Instruction::SubtractAWithE => 1,
            Instruction::SubtractAWithH => 1,
            Instruction::SubtractAWithL => 1,
            Instruction::SubtractAWithHL => 1,
            Instruction::SubtractAWithA => 1,
            Instruction::SubtractWithCarryAWithB => 1,
            Instruction::SubtractWithCarryAWithC => 1,
            Instruction::SubtractWithCarryAWithD => 1,
            Instruction::SubtractWithCarryAWithE => 1,
            Instruction::SubtractWithCarryAWithH => 1,
            Instruction::SubtractWithCarryAWithL => 1,
            Instruction::SubtractWithCarryAWithHL => 1,
            Instruction::SubtractWithCarryAWithA => 1,
            Instruction::AndAWithB => 1,
            Instruction::AndAWithC => 1,
            Instruction::AndAWithD => 1,
            Instruction::AndAWithE => 1,
            Instruction::AndAWithH => 1,
            Instruction::AndAWithL => 1,
            Instruction::AndAWithHL => 1,
            Instruction::AndAWithA => 1,
            Instruction::XorBWithA => 1,
            Instruction::XorCWithA => 1,
            Instruction::XorDWithA => 1,
            Instruction::XorEWithA => 1,
            Instruction::XorHWithA => 1,
            Instruction::XorLWithA => 1,
            Instruction::XorHLWithA => 1,
            Instruction::XorAWithA => 1,
            Instruction::OrBWithA => 1,
            Instruction::OrCWithA => 1,
            Instruction::OrDWithA => 1,
            Instruction::OrEWithA => 1,
            Instruction::OrHWithA => 1,
            Instruction::OrLWithA => 1,
            ...
            Instruction::CompareAWithH => 1,
            Instruction::CompareAWithL => 1,
            Instruction::CompareAWithHL => 1,
            Instruction::CompareAWithA => 1,
...
impl Display for Instruction {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let str = match self {
            ...
            Instruction::DecrementD => format!("DEC D"),
            ...
            Instruction::SetCarryFlag => format!("SCF"),
            ...
            Instruction::ComplimentCarryFlag => format!("CCF"),
            ...
            Instruction::AddAWithC => format!("ADD A, C"),
            Instruction::AddAWithD => format!("ADD A, D"),
            Instruction::AddAWithE => format!("ADD A, E"),
            Instruction::AddAWithH => format!("ADD A, H"),
            Instruction::AddAWithL => format!("ADD A, L"),
            Instruction::AddAWithHL => format!("ADD A, (HL)"),
            Instruction::AddAWithA => format!("ADD A, A"),
            Instruction::AddWithCarryAWithB => format!("ADC A, B"),
            Instruction::AddWithCarryAWithC => format!("ADC A, C"),
            Instruction::AddWithCarryAWithD => format!("ADC A, D"),
            Instruction::AddWithCarryAWithE => format!("ADC A, E"),
            Instruction::AddWithCarryAWithH => format!("ADC A, H"),
            Instruction::AddWithCarryAWithL => format!("ADC A, L"),
            Instruction::AddWithCarryAWithHL => format!("ADC A, (HL)"),
            Instruction::AddWithCarryAWithA => format!("ADC A, A"),
            Instruction::SubtractAWithB => format!("SUB A, B"),
            Instruction::SubtractAWithC => format!("SUB A, C"),
            Instruction::SubtractAWithD => format!("SUB A, D"),
            Instruction::SubtractAWithE => format!("SUB A, E"),
            Instruction::SubtractAWithH => format!("SUB A, H"),
            Instruction::SubtractAWithL => format!("SUB A, L"),
            Instruction::SubtractAWithHL => format!("SUB A, (HL)"),
            Instruction::SubtractAWithA => format!("SUB A, A"),
            Instruction::SubtractWithCarryAWithB => format!("SBC A, B"),
            Instruction::SubtractWithCarryAWithC => format!("SBC A, C"),
            Instruction::SubtractWithCarryAWithD => format!("SBC A, D"),
            Instruction::SubtractWithCarryAWithE => format!("SBC A, E"),
            Instruction::SubtractWithCarryAWithH => format!("SBC A, H"),
            Instruction::SubtractWithCarryAWithL => format!("SBC A, L"),
            Instruction::SubtractWithCarryAWithHL => format!("SBC A, (HL)"),
            Instruction::SubtractWithCarryAWithA => format!("SBC A, A"),
            Instruction::AndAWithB => format!("AND B"),
            Instruction::AndAWithC => format!("AND C"),
            Instruction::AndAWithD => format!("AND D"),
            Instruction::AndAWithE => format!("AND E"),
            Instruction::AndAWithH => format!("AND H"),
            Instruction::AndAWithL => format!("AND L"),
            Instruction::AndAWithHL => format!("AND (HL)"),
            Instruction::AndAWithA => format!("AND A"),
            Instruction::XorBWithA => format!("XOR B"),
            Instruction::XorCWithA => format!("XOR C"),
            Instruction::XorDWithA => format!("XOR D"),
            Instruction::XorEWithA => format!("XOR E"),
            Instruction::XorHWithA => format!("XOR H"),
            ...
            Instruction::OrDWithA => format!("OR D"),
            Instruction::OrEWithA => format!("OR E"),
            Instruction::OrHWithA => format!("OR H"),
            Instruction::OrLWithA => format!("OR L"),
            ...
            Instruction::CompareAWithH => format!("CP H"),
            Instruction::CompareAWithL => format!("CP L"),
            Instruction::CompareAWithHL => format!("CP (HL)"),
            Instruction::CompareAWithA => format!("CP A"),
...
impl InstructionBuilder {
    ...
    pub fn parse(self) -> Result<Instruction, InstructionParseError> {
        Ok(match self.0[0] {
            ...
            0x3F => Instruction::ComplimentCarryFlag,
            ...
            0x81 => Instruction::AddAWithC,
            0x82 => Instruction::AddAWithD,
            0x83 => Instruction::AddAWithE,
            0x84 => Instruction::AddAWithH,
            0x85 => Instruction::AddAWithL,
            0x86 => Instruction::AddAWithHL,
            0x87 => Instruction::AddAWithA,
            0x88 => Instruction::AddWithCarryAWithB,
            0x89 => Instruction::AddWithCarryAWithC,
            0x8A => Instruction::AddWithCarryAWithD,
            0x8B => Instruction::AddWithCarryAWithE,
            0x8C => Instruction::AddWithCarryAWithH,
            0x8D => Instruction::AddWithCarryAWithL,
            0x8E => Instruction::AddWithCarryAWithHL,
            0x8F => Instruction::AddWithCarryAWithA,
            0x90 => Instruction::SubtractAWithB,
            0x91 => Instruction::SubtractAWithC,
            0x92 => Instruction::SubtractAWithD,
            0x93 => Instruction::SubtractAWithE,
            0x94 => Instruction::SubtractAWithH,
            0x95 => Instruction::SubtractAWithL,
            0x96 => Instruction::SubtractAWithHL,
            0x97 => Instruction::SubtractAWithA,
            0x98 => Instruction::SubtractWithCarryAWithB,
            0x99 => Instruction::SubtractWithCarryAWithC,
            0x9A => Instruction::SubtractWithCarryAWithD,
            0x9B => Instruction::SubtractWithCarryAWithE,
            0x9C => Instruction::SubtractWithCarryAWithH,
            0x9D => Instruction::SubtractWithCarryAWithL,
            0x9E => Instruction::SubtractWithCarryAWithHL,
            0x9F => Instruction::SubtractWithCarryAWithA,
            0xA0 => Instruction::AndAWithB,
            0xA1 => Instruction::AndAWithC,
            0xA2 => Instruction::AndAWithD,
            0xA3 => Instruction::AndAWithE,
            0xA4 => Instruction::AndAWithH,
            0xA5 => Instruction::AndAWithL,
            0xA6 => Instruction::AndAWithHL,
            0xA7 => Instruction::AndAWithA,
            0xA8 => Instruction::XorBWithA,
            0xA9 => Instruction::XorCWithA,
            0xAA => Instruction::XorDWithA,
            0xAB => Instruction::XorEWithA,
            0xAC => Instruction::XorHWithA,
            ...
            0xB2 => Instruction::OrDWithA,
            0xB3 => Instruction::OrEWithA,
            0xB4 => Instruction::OrHWithA,
            0xB5 => Instruction::OrLWithA,
            ...
            0xBC => Instruction::CompareAWithH,
            0xBD => Instruction::CompareAWithL,
            0xBE => Instruction::CompareAWithHL,
            0xBF => Instruction::CompareAWithA,
